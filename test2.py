...
conver_IB_130 = (df.values[0, 0] * (df.values[0,24]/100 - df.values[0, 9] / 100) -df.values[0,9]/100*df.values[0, 3] - df.values[0,9]/100*df.values[0, 6]) / (
                        1 - df.values[0, 9]/100)
conver_IB_140 = (df.values[0, 1] * (df.values[0,24]/100 - df.values[0, 10] / 100) -df.values[0,10]/100*df.values[0, 4] - df.values[0,10]/100*df.values[0, 7]) / (
                        1 - df.values[0, 10]/100)
conver_IB_150 = (df.values[0, 2] * (df.values[0,24]/100 - df.values[0, 11] / 100) -df.values[0,11]/100*df.values[0, 5] - df.values[0,11]/100*df.values[0, 8]) / (
...
tc_liq_130 = method.compute_thermal_conductivity_TRAPP(T_130_log_mean-273.15, df.values[0, 9] / 100)
tc_liq_140 = method.compute_thermal_conductivity_TRAPP(T_140_log_mean-273.15, df.values[0, 10] / 100)
tc_liq_150 = method.compute_thermal_conductivity_TRAPP(T_150_log_mean-273.15, df.values[0, 11] / 100)
